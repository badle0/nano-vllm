...
@pytest.mark.parametrize("budget,expected_steps", [(64, 79), (128, 43), (256, 26)])
def test_partial_prefill_is_reclaimed_before_interrupting_decode(
